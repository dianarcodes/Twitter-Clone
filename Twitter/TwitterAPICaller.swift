...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "1FupY3qxxTawfYDlM1VDsA015", consumerSecret: "Q1t7Ku8mUsbeUY0l7ZAqJxgP3e7aLZGCE9CLsih2HlmirJ58go")
    var loginSuccess: (() -> ())?
